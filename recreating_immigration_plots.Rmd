...
Now, we get the topic model data. The topic model was given to us by Jake Hofman of Microsoft Research. We aren't sure where he got it from. The model is not included in the repository because it was too big to fit.
